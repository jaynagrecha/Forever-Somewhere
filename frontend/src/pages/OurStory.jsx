...
export default function OurStory() {
  ...
  return (
    <PageShell title="📖 Our Story" subtitle="The timeline of us — milestones from Moments, in order.">
      <div className="relative space-y-0">
        ...
        {milestones.map((m, i) => (
          ...
          >
            ...
            >
              <span className="text-xs text-accent-soft">{m.milestone_type || 'Milestone'}</span>
